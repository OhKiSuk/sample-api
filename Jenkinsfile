...
def gitUrl = "https://github.com/OhKiSuk/${PROJECT_NAME}.git"
def gitOpsUrl = "https://github.com/OhKiSuk/sample-gitops.git"
def opsBranch = "main"
/////////////////////////////
pipeline {
     environment {
        ...
        stage('GitOps update') {
            steps {
                    ...
                    withCredentials([
                        ...
                        kustomize edit set image giseokoh/sample-api:${TAG}
                        # 로컬외에는 주석 제거한다
